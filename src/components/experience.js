      ...
      <div className="experience container">
        ...
        <div className="experience-content">
          <div className="row-experience">
            <img className="image-pirashield" src={require('../../public/imgs/pirashield.png')} alt='pirashield'/>
          ...
          <div className="row-experience">
            ...
            <img className="image-arobooks" src={require('../../public/imgs/arobooks.png')} alt='arobooks'/>
          </div>
        </div>
      </div>
    );
